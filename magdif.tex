...
\begin{align}
\int_{1,2}\,R\boldsymbol{j}_{n}^{\text{pol}}\cdot\boldsymbol{n}d\Gamma+in\int Rj_{n}^{\varphi}d\Omega & =-\int_{3}\,R\boldsymbol{j}_{\perp n}^{\text{pol}}\cdot\boldsymbol{n}d\Gamma.
\end{align}
On edge 3 we use
\begin{align}
\boldsymbol{j}_{n}\times\boldsymbol{B}_{0} & =c(\nabla p_{n}+in\,p_{n}\nabla\varphi)-\boldsymbol{j}_{0}\times\boldsymbol{B}_{n}.
\end{align}
Scalar multiplication by \textbf{$\boldsymbol{e}_{\ph}=\frac{\partial\boldsymbol{R}}{\partial\ph}$
}yields
\begin{align}
\boldsymbol{e}_{\ph}\cdot(\boldsymbol{j}_{n}\times\boldsymbol{B}_{0}) & =\boldsymbol{j}_{n}\cdot(\boldsymbol{B}_{0}\times\boldsymbol{e}_{\ph})=RB_{0}^{\text{pol}}\boldsymbol{j}_{n}\cdot\boldsymbol{n}
\end{align}
This results in
\begin{align*}
\boldsymbol{j}_{n}\cdot\boldsymbol{n} & =\frac{1}{RB_{0}^{\text{pol}}}\left(in\,p_{n}-\boldsymbol{j}_{0}\cdot(\boldsymbol{B}_{n}\times\boldsymbol{e}_{\ph})\right)\\
 & =\frac{1}{RB_{0}^{\text{pol}}}\left(in\,p_{n}+R\boldsymbol{j}_{0}\cdot\boldsymbol{B}_{n}^{\text{pol}}\right).
\end{align*}
...
\item Unit vector:
\begin{align*}
\boldsymbol{h} & \approx\boldsymbol{h}_{0}+\frac{\delta\boldsymbol{B}_{\perp}}{B_{0}}\\
\delta\boldsymbol{B}_{\perp} & =\delta\boldsymbol{B}-\boldsymbol{h}_{0}(\boldsymbol{h}_{0}\cdot\delta\boldsymbol{B})
\end{align*}
\item Current density:
\begin{align}
\boldsymbol{j}-\boldsymbol{j}_{0} & =(j_{0\parallel}+\delta j_{\parallel}^{\prime})\boldsymbol{h}+\boldsymbol{j}_{\perp}-j_{0\parallel}\boldsymbol{h}_{0}-\boldsymbol{j}_{0\perp}\nonumber \\
 & =\delta j_{\parallel}^{\prime}\boldsymbol{h}_{0}+j_{0\parallel}\frac{\delta\boldsymbol{B}_{\perp}}{B_{0}}+\delta\boldsymbol{j}_{\perp}^{\prime}\equiv\delta\boldsymbol{j}.
\end{align}
\item More:
\begin{itemize}
\item Take from above
\item More:
\begin{align*}
(\boldsymbol{h}_{0}\times(\boldsymbol{j}_{0}\times\boldsymbol{B}_{0}))\times\boldsymbol{B}_{0} & =B_{0}(\boldsymbol{j}_{0}\times\boldsymbol{B}_{0})\\
(\boldsymbol{h}_{0}\times\nabla\delta p)\times\boldsymbol{B}_{0} & =B_{0}\nabla\delta p-(\boldsymbol{B}_{0}\cdot\nabla\delta p)\boldsymbol{h}_{0}
\end{align*}
\item Put together:
\begin{align*}
\delta\boldsymbol{j}_{\perp}\times\boldsymbol{B}_{0} & =c\nabla\delta p-(\boldsymbol{h}_{0}\cdot\nabla\delta p)\boldsymbol{h}_{0}-\boldsymbol{j}_{0}\times\delta\boldsymbol{B}
\end{align*}
\end{itemize}
\item Currents
\begin{align}
\boldsymbol{j}_{0}\times\boldsymbol{B}_{0}+\boldsymbol{j}_{0}\times\delta\boldsymbol{B}+\delta\boldsymbol{j}\times\boldsymbol{B}_{0} & =c(\nabla p_{0}+\nabla p_{1})
\end{align}
\begin{align}
\delta\boldsymbol{B}\cdot(\boldsymbol{j}_{0}\times\boldsymbol{B}_{0}) & =c(\delta\boldsymbol{B}\cdot\nabla p_{0}+\delta\boldsymbol{B}\cdot\nabla p_{1})
\end{align}
\begin{align}
\delta\boldsymbol{B}\cdot(\boldsymbol{j}_{0}\times\boldsymbol{B}_{0}) & =c(\delta\boldsymbol{B}\cdot\nabla p_{0}+\delta\boldsymbol{B}\cdot\nabla p_{1})
\end{align}
\end{itemize}
On edge 3 we evaluate
\begin{align}
\boldsymbol{j}_{\perp n}^{\text{pol}}\cdot\boldsymbol{n} & =j_{0\parallel}\frac{B_{\perp n}^{\text{pol}}}{B_{0}}+\frac{c}{B_{0}}\boldsymbol{n}\cdot(\boldsymbol{h}_{0}\times(\nabla p_{n}+inp_{n}\nabla\ph)).
\end{align}
Rotating the triple product and using the fact that both, $\boldsymbol{n}$
and $\nabla p_{n}$ are in the poloidal plane, yields
\begin{align}
\boldsymbol{n}\cdot\boldsymbol{h}_{0}\times(\nabla p_{n}+inp_{n}\nabla\ph) & =inp_{n}\boldsymbol{h}_{0}\cdot\nabla\ph\times\boldsymbol{n}=\frac{in}{R}p_{n}
\end{align}
on edge 3.
